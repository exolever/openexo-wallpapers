...
echo "Generating openexo-wallpapers.xml..."
...
echo "<wallpapers>" >> openexo-wallpapers.xml
  ...
  for i in $(ls -C1 images | grep -e "png" -e "jpg" )
  do
...
sed -i "1i \ " debian/changelog
sed -i "1i openexo-wallpapers ($NEW_VERSION) bionic; urgency=low"  debian/changelog
